...
const TRANSITIONS: Readonly<Record<Exclude<RunStatus, 'PAUSED'>, ReadonlySet<RunStatus>>> = {
  PLANNING: new Set(['AWAITING_BLUEPRINT_APPROVAL', 'EXECUTING', 'RECOVERING', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED']),
  AWAITING_BLUEPRINT_APPROVAL: new Set(['PLANNING', 'EXECUTING', 'CANCELLED']),
  EXECUTING: new Set(['PAGE_REVIEW', 'PAUSED', 'RECOVERING', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED']),
  PAGE_REVIEW: new Set(['DECK_REVIEW', 'REVISING', 'PAUSED', 'RECOVERING', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED']),
  DECK_REVIEW: new Set(['AWAITING_REVISION_APPROVAL', 'REVISING', 'PAUSED', 'RECOVERING', 'NEEDS_HUMAN', 'DELIVERING', 'FAILED', 'CANCELLED']),
  AWAITING_REVISION_APPROVAL: new Set(['REVISING', 'PAUSED', 'NEEDS_HUMAN', 'CANCELLED']),
  REVISING: new Set(['EXECUTING', 'PAGE_REVIEW', 'DECK_REVIEW', 'PAUSED', 'RECOVERING', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED']),
  NEEDS_HUMAN: new Set(['PLANNING', 'REVISING', 'DELIVERING', 'CANCELLED']),
  DELIVERING: new Set(['COMPLETED', 'RECOVERING', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED']),
  RECOVERING: new Set(['PLANNING', 'EXECUTING', 'PAGE_REVIEW', 'DECK_REVIEW', 'REVISING', 'DELIVERING', 'FAILED', 'CANCELLED']),
  COMPLETED: new Set(),
  FAILED: new Set(),
  CANCELLED: new Set(),
}
